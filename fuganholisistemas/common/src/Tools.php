...
namespace FuganholiSistemas\Common;
 ...
 * Classe Tools
 *
 * Classe responsável pela comunicação com a API NFEasy
 *
 * @category  NFEasy
 * @package   FuganholiSistemas\Common\Tools
...
class Tools
{
    ...
    /**
     * Consulta uma empresa no NFEasy
     */
